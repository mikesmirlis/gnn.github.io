$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Giannis, Natalia, Nikos",

            // Event start date
            start: new Date('Sep 13, 2025 10:00'),
            ...
            // Event Description
            description: "Περιμένουμε να σε δούμε! Για οτιδήποτε, κάλεσε τον Φουφουτο στο +30 694222222"
        }
    });
...
// Google map
function initMap() {
    var location = {lat: 35.2790796, lng: 25.1678244};
